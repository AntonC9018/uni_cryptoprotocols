...
AESContext!(Yes.encrypt) createEncryptionContext(size_t keyLength)(in ubyte[keyLength] key)
{
	...
	switch (keyLength)
	{
		case 128 / 8:
			...
			{
				RK[4] = RK[0] ^ RCON[i] ^
					(cast(uint)FSb[(RK[3] >> 8) & 0xFF]) ^
					(cast(uint)FSb[(RK[3] >> 16) & 0xFF] << 8) ^
					(cast(uint)FSb[(RK[3] >> 24) & 0xFF] << 16) ^
					(cast(uint)FSb[(RK[3]) & 0xFF] << 24);
		...
		case 192 / 8:
			...
			{
				RK[6] = RK[0] ^ RCON[i] ^
					(cast(uint)FSb[(RK[5] >> 8) & 0xFF]) ^
					(cast(uint)FSb[(RK[5] >> 16) & 0xFF] << 8) ^
					(cast(uint)FSb[(RK[5] >> 24) & 0xFF] << 16) ^
					(cast(uint)FSb[(RK[5]) & 0xFF] << 24);
		...
		case 256 / 8:
			...
			{
				RK[8] = RK[0] ^ RCON[i] ^
					(cast(uint)FSb[(RK[7] >> 8) & 0xFF]) ^
					(cast(uint)FSb[(RK[7] >> 16) & 0xFF] << 8) ^
					(cast(uint)FSb[(RK[7] >> 24) & 0xFF] << 16) ^
					(cast(uint)FSb[(RK[7]) & 0xFF] << 24);
				...
				RK[12] = RK[4] ^
					(cast(uint)FSb[(RK[11]) & 0xFF]) ^
					(cast(uint)FSb[(RK[11] >> 8) & 0xFF] << 8) ^
					(cast(uint)FSb[(RK[11] >> 16) & 0xFF] << 16) ^
					(cast(uint)FSb[(RK[11] >> 24) & 0xFF] << 24);
...
ubyte[16] cryptEcb(TContext : AESContext!encrypt, Flag!"encrypt" encrypt)(in TContext ctx, in ubyte[16] input)
{
	...
	const(uint)* RK = ctx.buf.ptr;

	uint X0 = (cast(uint)input[0]) | (cast(uint)input[1] << 8) | (cast(uint)input[2] << 16) | (cast(uint)input[3] << 24);
	X0 ^= *RK++;
	uint X1 = (cast(uint)input[4]) | (cast(uint)input[5] << 8) | (cast(uint)input[6] << 16) | (cast(uint)input[7] << 24);
	X1 ^= *RK++;
	uint X2 = (cast(uint)input[8]) | (cast(uint)input[9] << 8) | (cast(uint)input[10] << 16) | (cast(uint)input[11] << 24); 
	X2 ^= *RK++;
	...
	static if (!encrypt)
	{
		...
		X0 = *RK++ ^ (cast(uint)RSb[Y0 & 0xFF]) ^
			(cast(uint)RSb[(Y3 >> 8) & 0xFF] << 8) ^
			(cast(uint)RSb[(Y2 >> 16) & 0xFF] << 16) ^
			(cast(uint)RSb[(Y1 >> 24) & 0xFF] << 24);

		X1 = *RK++ ^ (cast(uint)RSb[Y1 & 0xFF]) ^
			(cast(uint)RSb[(Y0 >> 8) & 0xFF] << 8) ^
			(cast(uint)RSb[(Y3 >> 16) & 0xFF] << 16) ^
			(cast(uint)RSb[(Y2 >> 24) & 0xFF] << 24);

		X2 = *RK++ ^ (cast(uint)RSb[Y2 & 0xFF]) ^
			(cast(uint)RSb[(Y1 >> 8) & 0xFF] << 8) ^
			(cast(uint)RSb[(Y0 >> 16) & 0xFF] << 16) ^
			(cast(uint)RSb[(Y3 >> 24) & 0xFF] << 24);

		X3 = *RK++ ^ (cast(uint)RSb[Y3 & 0xFF]) ^
			(cast(uint)RSb[(Y2 >> 8) & 0xFF] << 8) ^
			(cast(uint)RSb[(Y1 >> 16) & 0xFF] << 16) ^
			(cast(uint)RSb[(Y0 >> 24) & 0xFF] << 24);
	}
	else
	{
		for (int i = (ctx.nr >> 1) - 1; i > 0; --i)
		...
		X0 = *RK++ ^ (cast(uint)FSb[Y0 & 0xFF]) ^
			(cast(uint)FSb[(Y1 >> 8) & 0xFF] << 8) ^
			(cast(uint)FSb[(Y2 >> 16) & 0xFF] << 16) ^
			(cast(uint)FSb[(Y3 >> 24) & 0xFF] << 24);

		X1 = *RK++ ^ (cast(uint)FSb[Y1 & 0xFF]) ^
			(cast(uint)FSb[(Y2 >> 8) & 0xFF] << 8) ^
			(cast(uint)FSb[(Y3 >> 16) & 0xFF] << 16) ^
			(cast(uint)FSb[(Y0 >> 24) & 0xFF] << 24);

		X2 = *RK++ ^ (cast(uint)FSb[Y2 & 0xFF]) ^
			(cast(uint)FSb[(Y3 >> 8) & 0xFF] << 8) ^
			(cast(uint)FSb[(Y0 >> 16) & 0xFF] << 16) ^
			(cast(uint)FSb[(Y1 >> 24) & 0xFF] << 24);

		X3 = *RK++ ^ (cast(uint)FSb[Y3 & 0xFF]) ^
			(cast(uint)FSb[(Y0 >> 8) & 0xFF] << 8) ^
			(cast(uint)FSb[(Y1 >> 16) & 0xFF] << 16) ^
	...
	output[3] = cast(ubyte)(X0 >> 24);
	output[4] = cast(ubyte)(X1 >> 0);
	output[5] = cast(ubyte)(X1 >> 8);
	output[6] = cast(ubyte)(X1 >> 16);
	output[7] = cast(ubyte)(X1 >> 24);
	output[8] = cast(ubyte)(X2 >> 0); 
	output[9] = cast(ubyte)(X2 >> 8);
	output[10] = cast(ubyte)(X2 >> 16);
	output[11] = cast(ubyte)(X2 >> 24);
	output[12] = cast(ubyte)(X3 >> 0);
